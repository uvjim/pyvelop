...
class MeshCapability:
    ...
    async def async_execute(
        ...
        *,
        ...
        Capabability availablility is also updated. This only happens if the target node is the
        ...
        try:
            ...
            items = resp.items
            if isinstance(req.payload, dict):  # JnapResponseSingle
                _data = items[0] if items else None
                if _data is not None:
                    ret = _data
            else:  # JnapResponseTransaction
                ret_list: list[dict[str, Any]] = []
                for response_payload, response_data in zip(req.payload, items, strict=True):
            ...
            if exc.action == self.action_uri:  # singlular request
                ...
                if (
                    ...
                    and capabilities_by_uri is not None
                    and (cap := capabilities_by_uri.get(exc.action)) is not None
                ):
                    cap.mark_as_invalid()
            raise
    ...
    def mark_as_valid(self) -> None:
        """Mark the capability as valid."""

        self._is_valid = True

    def reset_validity(self) -> None:
        """Reset the capability validity so it can be tested again."""
...
class MeshSnapshot(MeshSerialise):
    ...
    def __init__(
        ...
        object.__setattr__(self, "_capabilities", MappingProxyType(dict(available_capabilities)))
        object.__setattr__(self, "_discovered_devices", discovered_devices)
        object.__setattr__(self, "_gather_timings", MappingProxyType(dict(gather_timings)))
        object.__setattr__(self, "_values", MappingProxyType(dict(gathered_details)))
    ...
    def _find_capability(self, capability: ActionKey) -> MeshCapability | None:
        ...
        :return: The matching MeshCapability, or None if it is not available or invalid.
        """
        cap = self._capabilities.get(capability)
        return cap if cap and cap.is_valid is not False else None

    def _require_capability(self, capability: ActionKey, *, attribute_name: str) -> None:
        ...
        """
        if self._find_capability(capability) is None:
    ...
    def capabilities(self) -> tuple[Mapping[str, Any], ...]:
        ...
        :return: Tuple of mesh capabilities.
        """
        return tuple(
            MappingProxyType(
                {
    ...
    def check_for_update_status(self) -> MeshAttribute[bool | None]:
        ...
        :return: True if checking for update.
        """
        cap_name = "GET_UPDATE_FIRMWARE_STATE"
        self._require_capability(cap_name, attribute_name="check_for_update_status")

        node_results = self._values.get(cap_name, {}).get("firmwareUpdateStatus", [])
        is_checking = any("pendingOperation" in node for node in node_results)

        return MeshAttribute[bool | None](is_checking, (AttributeAuditEntry(cap_name, is_checking),))
    ...
    def client_steering_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isClientSteeringEnabled")
    ...
    def dhcp_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isDHCPEnabled")
    ...
    def dhcp_reservations(self) -> MeshAttribute[tuple[Mapping[str, str], ...]]:
        ...
        all_reservations: list[dict[str, Any]] = (
            self._values.get(cap_name, {}).get("dhcpSettings", {}).get("reservations", [])
        )
    ...
    def express_forwarding_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isExpressForwardingEnabled")
    ...
    def express_forwarding_supported(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isExpressForwardingSupported")
    ...
    def firmware_update_setting(self) -> MeshAttribute[FirmwareUpdatePolicy | None]:
        ...
        attr: str | None = self._values.get(cap_name, {}).get("updatePolicy")
        if attr is not None:
    ...
    def guest_wifi_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isGuestNetworkEnabled")
    ...
    def guest_wifi_details(self) -> MeshAttribute[tuple[Mapping[str, str], ...]]:
        ...
        radios: list[dict[str, str | bool]] = self._values.get(cap_name, {}).get("radios", [])
    ...
    def homekit_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isEnabled")
    ...
    def homekit_paired(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isPaired")
    ...
    def is_channel_scan_running(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isRunning")
    ...
    def is_in_bridge_mode(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool = self._values.get(cap_name, {}).get("detectedWANType", "").lower() == "bridge"
    ...
    def last_gather_details(self) -> tuple[tuple[str, float], ...]:
        ...
        ret: list[tuple[str, float]] = list(self._gather_timings.items())
    ...
    def mac_filtering_addresses(self) -> MeshAttribute[tuple[str, ...]]:
        ...
        attr: list[str] = self._values.get(cap_name, {}).get("macAddresses", [])
    ...
    def mac_filtering_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool = self._values.get(cap_name, {}).get("macFilterMode", "").lower() != "disabled"
    ...
    def mac_filtering_mode(self) -> MeshAttribute[MacFilteringMode | None]:
        ...
        _mode: str | None = self._values.get(cap_name, {}).get("macFilterMode")
    ...
    def mlo_state(self) -> MeshAttribute[bool | None]:
        ...
        ret: bool | None = None
        attr: dict[str, bool] | None = self._values.get(cap_name)
        if attr is not None:
    ...
    def night_mode(self) -> MeshAttribute[NightModeState | None]:
        ...
        attr: dict[str, bool | int] | None = self._values.get(cap_name)
    ...
    def node_steering_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isNodeSteeringEnabled")
    ...
    def nodes(self) -> tuple[NodeEntity, ...]:
        ...
        """
        ret: list[NodeEntity] = [node for node in self._discovered_devices if isinstance(node, NodeEntity)]
    ...
    def parental_control_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isParentalControlEnabled")
    ...
    def scheduled_reboot_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isScheduledRebootEnabled")
    ...
    def scheduled_reboot_interval(self) -> MeshAttribute[ScheduledRebootInterval | None]:
        ...
        attr: dict[str, Any] = self._values.get(cap_name, {}).get("rebootInterval")
        if attr is not None:
    ...
    def sip_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isSIPEnabled")
    ...
    def speedtest_results(self) -> MeshAttribute[tuple[SpeedtestResult, ...]]:
        ...
        raw_results: list[dict[str, Any]] = self._values.get(cap_name, {}).get("healthCheckResults", [])
    ...
    def storage_available(self) -> MeshAttribute[tuple[Mapping[str, Any], ...]]:
        ...
        device: dict[str, Any]
        storage_available = self._values.get(cap_name, {})
    ...
    def storage_settings(self) -> MeshAttribute[dict[str, Any]]:
        ...
        attr: dict[str, Any] = self._values.get(cap_name, {})
    ...
    def upnp_enabled(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("isUPnPEnabled")
    ...
    def upnp_allow_change_settings(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("canUsersConfigure")
    ...
    def upnp_allow_disable_internet(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("canUsersDisableWANAccess")
    ...
    def wan_ip(self) -> MeshAttribute[str | None]:
        ...
        attr = self._values.get(cap_name, {}).get("wanConnection", {}).get("ipAddress")
    ...
    def wan_mac(self) -> MeshAttribute[str | None]:
        ...
        attr = self._values.get(cap_name, {}).get("macAddress")
    ...
    def wan_status(self) -> MeshAttribute[bool | None]:
        ...
        ret: bool | None = None
        attr = self._values.get(cap_name, {}).get("wanStatus")
        if attr:
    ...
    def wps_state(self) -> MeshAttribute[bool | None]:
        ...
        attr: bool | None = self._values.get(cap_name, {}).get("enabled")
...
class Mesh:
    ...
    def _get_capability(self, capability: ActionKey) -> MeshCapability:
        ...
        Raises ValueError if the requested capability is not available.
    ...
    def _get_node_details_from_raw(self, raw_details: dict[ActionKey, Any]) -> tuple[dict[str, Any], ...]:
        """Retrieve node information directly from the raw details.

        Important to note that no remediation has been carried out and this is just from the raw
    ...
    def _reset_capability_validity(self) -> None:
        """Allow all capabilities to be tested again after a node state change."""

        _LOGGER_VERBOSE.debug("resetting capability validation")
        for capability in self._capabilities.values():
            capability.reset_validity()
    ...
    async def _async_gather_node_details(
        ...
        for node in nodes:
            ...
            for txn in txn_payload:
                requests.append(
                    cap.async_execute(
                        node_address=node["ip"], payload=txn, capabilities_by_uri=capabilities_by_action_uri
                    )
                )
    ...
    async def _async_get_speedtest_results(
        ...
        cap: MeshCapability = self._get_capability("GET_SPEEDTEST_RESULTS")
    ...
    async def async_check_for_updates(self) -> None:
        ...
        cap: MeshCapability = self._get_capability("UPDATE_FIRMWARE")
    ...
    async def async_get_update_state(self) -> bool:
        ...
        cap: MeshCapability = self._get_capability("GET_UPDATE_FIRMWARE_STATE")
        resp: JnapResponseSingle = await cap.async_execute()
    ...
    async def async_set_guest_wifi_state(self, state: bool) -> None:
        ...
        cap: MeshCapability = self._get_capability("GET_GUEST_NETWORK_INFO")
        resp: JnapResponseSingle = await cap.async_execute()
    ...
    async def async_set_scheduled_reboot_state(self, state: bool) -> None:
        ...
        cap: MeshCapability = self._get_capability("GET_SCHEDULED_REBOOT_SETTINGS")
        resp: JnapResponseSingle = await cap.async_execute()
    ...
    async def async_start_channel_scan(self) -> None:
        ...
        try:
            cap: MeshCapability = self._get_capability("START_CHANNEL_SCAN")
            await cap.async_execute()
    ...
    async def async_start_speedtest(
        ...
        *,
        ...
        cap: MeshCapability = self._get_capability("START_SPEEDTEST")
        payload: JnapPayloadSingle = {
